...
export default function CharacterOfTheDay({
  ...
  return (
    <>
      <div
        className={clsx(
          "fixed inset-0 bottom-[35%] lg:bottom-0 bg-cover bg-center z-[-1]",
      ...
      <div
        className={clsx(
          "fixed inset-0 top-[30%] lg:top-[50%] lg:from-50% bg-gradient-to-t from-black from-70% to-transparent z-[-1]"
        )}
      />
      ...
      <div className="app-layout p-8 size-full max-w-screen-lg mx-auto">
        ...
        <div className="[grid-area:character] flex items-end justify-center">
          <Character
            ...
            className="[&>svg]:h-[20rem] [&>svg]:w-[15rem] lg:[&>svg]:h-[40rem] lg:[&>svg]:w-[30rem]"
          />
        </div>
